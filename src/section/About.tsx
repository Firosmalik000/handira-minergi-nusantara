    ...
    <section id="about" className="w-full bg-gray-200 py-20 px-6 md:px-20 lg:px-32">
      <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -30 }} transition={{ duration: 0.8 }} className="flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-[40%] text-gray-800">
          <motion.h2 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -30 }} transition={{ duration: 0.8 }} className="text-3xl md:text-4xl font-playfair font-bold mb-4  text-center">
            {content[language].title}
          </motion.h2>

          <motion.h3 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -30 }} transition={{ duration: 0.8 }} className="text-xl md:text-2xl font-semibold mb-6  text-center">
            {content[language].tag}
          </motion.h3>

          <motion.p whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -30 }} transition={{ duration: 0.8 }} className="text-sm md:text-lg leading-relaxed text-justify indent-8">
